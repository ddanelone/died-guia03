...
import died.guia03.ejercicio03.Registro;
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        for(int i=0;i<10;i++) {
            r1.agregar(new Temperatura(generadorAleatorio.nextDouble()*50, Temperatura.Escala.CELCIUS));
        }
        for(int i=0;i<10;i++) {
            r2.agregar(new Temperatura(generadorAleatorio.nextDouble()*85 + 20, Temperatura.Escala.FAHRENHEIT));
        }
